...
export const Theme: React.FC = ({ children }) => {
    ...
    const theme = {
        ...
        color: {
            ...
            primaryContrast: bestContrast(globalTheme.color.primary, globalTheme.color.white, globalTheme.color.black),
            ...
            foreground: darkMode ? mix(0.8, globalTheme.color.white, globalTheme.color.black) : globalTheme.color.black,
