...
export const PrismTheme = css`
    ...
    pre[class*='language-'] {
        ...
        background-color: ${props => mix(0.975, props.theme.color.background, props.theme.color.foreground)};
    }
    ...
    code[class*='language-'] {
        ...
        border: 1px solid ${props => transparentize(0.95, props.theme.color.foreground)};
    }
    ...
    pre[class*='language-'] {
        ...
        font-size: 0.8em;
        padding: 1.5rem;
        border-top: 1px solid ${props => transparentize(0.95, props.theme.color.foreground)};
        border-bottom: 1px solid ${props => transparentize(0.95, props.theme.color.foreground)};
...
export const GlobalStyles = createGlobalStyle`
    ...
    blockquote {
        ...
        padding: 1rem 1.5rem;
        border-radius: 0 ${props => props.theme.radius.small} ${props => props.theme.radius.small} 0;
        background-color: ${props => transparentize(0.95, props.theme.color.foreground)};
    ...
    a:not([class]):visited {
        ...
        text-decoration-color: ${props => transparentize(0.75, props.theme.color.link)};
        transition: all 150ms ${props => props.theme.easing};
        &:hover {
        color: ${props => shade(0.1, props.theme.color.link)};
        text-decoration-color: ${props => transparentize(0.5, props.theme.color.link)};
        }
        &:focus {
        color: ${props => shade(0.1, props.theme.color.link)};
...
export const Paper = styled.div<{ article?: boolean; center?: boolean }>`
    position: relative;
    background-color: ${props => props.theme.color.background};
    ...
    ${props =>
        props.theme.isDarkMode &&
        css`
            background-color: ${props => mix(0.92, props.theme.color.background, props.theme.color.foreground)};
        `};
...
const ButtonStyles = css<{ primary?: string }>`
    display: inline-block;
    position: relative;
    line-height: 2.25rem;
    font-size: 1rem;
    ...
    color: ${props => props.theme.color.foreground};
    background-color: ${props => props.theme.color.background};
    border-bottom: 3px solid ${props => transparentize(0.8, props.theme.color.black)};
    cursor: pointer;
    z-index: 1;
    box-shadow: 0 3px 4px ${props => transparentize(0.8, props.theme.color.black)};
    text-shadow: 0 1px 1px ${props => transparentize(0.5, props.theme.color.black)};
    ...
    &:before {
        ...
        top: 0;
        left: 0;
        border-radius: ${props => props.theme.radius.small} ${props => props.theme.radius.small} 0 0;
        transition: all 150ms ${props => props.theme.easing};
    }

    &:after {
        box-shadow: inset 0 0 3px ${props => transparentize(0.6, props.theme.color.black)};
    }
...
export const DraftBadge = styled.span`
    ...
    border-radius: 0 ${props => props.theme.radius.small} 0 ${props => props.theme.radius.small};
    color: ${props => props.theme.color.primaryContrast};
...
export const EditButton = styled.button`
    ...
    font-size: 0.9rem;
    padding: 0.5rem 0.75rem;
    border-radius: ${props => props.theme.radius.small} 0 ${props => props.theme.radius.small} 0;
    color: ${props => props.theme.color.primaryContrast};
    background: ${props => props.theme.color.primary};
    ...
    left: 0;
    top: 0;
    height: calc(${props => props.theme.header.height} - 6px);
    z-index: 9999;
    cursor: pointer;
`
