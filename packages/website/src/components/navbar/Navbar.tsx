...
export const StyledNavbar = styled.ul<{ isDarkMode?: boolean; navOpen: boolean }>`
    color: inherit;
...
export const NavItem = styled.li`
    ...
    @media (max-width: ${props => props.theme.breakpoints.small}) {
        &:not(:last-child) {
            border-bottom: 1px solid ${props => transparentize(0.85, props.theme.color.white)};
        }
    }
`
...
export const StyledNavItemMixin = css`
    ...
    ${props =>
        ...
        css`
            ...
            &.active {
                color: ${props =>
                    props.theme.isDarkMode ? props.theme.color.foreground : props.theme.color.primary} !important;
                &:before {
                    opacity: 1;
                }
            }
        ...
        css`
            ...
            &:before {
                ...
                background: linear-gradient(
                    to bottom,
                    ${props => transparentize(0.75, mix(0.25, props.theme.color.white, props.theme.color.black))},
                    transparent 1.5rem
                );
                opacity: 0;
                z-index: -1;
            ...
            &.active {
                &:before {
                    background: linear-gradient(
                        to bottom,
                        ${props => transparentize(0.75, mix(0.5, props.theme.color.white, props.theme.color.black))},
                        transparent 1.5rem
                    );
                }
            }
